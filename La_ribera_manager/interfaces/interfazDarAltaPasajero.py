...
class InterfazDarAltaPasajero:
	def __init__(self):
		...
		self.ePais = builder.get_object("eventbox_pais")
		self.eNacionalidad = builder.get_object("eventbox_nacionalidad")
		self.eOcupacion = builder.get_object("eventbox_ocupacion")
		self.eProvincia = builder.get_object("eventbox_provincia")
		self.eLocalidad = builder.get_object("eventbox_localidad")
		self.eDocumento = builder.get_object("eventbox_dni")
		self.eIVA = builder.get_object("eventbox_iva")
		self.eFecha = builder.get_object("eventbox_fecha")

class DtoPasajero:
	def __init__(self, nombre=None, apellido=None, cuit=None,
			...
			id_localidad=None, id_provincia=None, id_pais=None,
		...
		self.setIdLocalidad(id_localidad)
		self.setIdProvincia(id_provincia)
		self.setIdPais(id_pais)

		#Atributos de ocupacion y nacionalidad
		self.setIdOcupacion(id_ocupacion)
		self.setIdNacionalidad(id_nacionalidad)

		#Atributos de posicion frente al IVA
		self.setIdIva(id_iva)
